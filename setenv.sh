...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/Python-2.7/lib:/usr/local/$GCC/lib64:/usr/local/VTK-7.0.0/lib:$HOME/Downloads/paralution-1.1.0/build/lib:/usr/local/Qt-4.8.7/lib
